...
export default function Cart() {
    ...
    return (
        <Box my={2} display={'flex'} flexDirection={{xs: 'column', sm: 'row'}} alignItems={'center'} gap={3} justifyContent={'space-between'} flexWrap={'wrap'}>
            ...
            <Box sx={{ display: 'flex', borderRadius: 1, alignItems: 'center', flexDirection:'column', color: '#607d8b', '&:hover': { color: '#fff', backgroundColor: '#607d8b', cursor: 'pointer' }, fontWeight: 600, gap: 1, paddingY: 1, paddingX: 2, border: '2px solid #607d8b', transitionDuration: '250ms', minWidth: '200px' }}>
